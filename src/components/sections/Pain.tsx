      ...
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 md:col-span-8 md:col-start-3">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            variants={fadeUp}
            className="text-3xl sm:text-4xl md:text-5xl font-bold text-text leading-tight tracking-tight mb-8"
          >
          ...
          >
            ...
            <p className="text-text text-base sm:text-lg font-medium leading-relaxed">
